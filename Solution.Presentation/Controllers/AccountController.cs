...
namespace Solution.Presentation.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    if (User.Identity.GetUserId().Equals("195b3ecf-65a9-4ef6-b8ab-e45d4c70640c") || User.Identity.GetUserName().Equals("beedis"))
                    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model , HttpPostedFileBase Image)
        {
            if (ModelState.IsValid)
            {
                var user = new User { UserName = model.UserName, FirstName= model.FirstName,Email = model.Email , DateOfBirth = model.DateOfBirth , Image = Image.FileName, LastName = model.LastName };
